 ...
 * Cyber Dark Edition for CBSE Chemistry
 */
(function() {
  'use strict';
      ...
      <div class="academy-modal-dialog" role="dialog" aria-labelledby="academyModalTitle">
        <div class="academy-modal-header">
          <div class="academy-brand-title">
            ...
            <div>
              ...
              <p class="academy-subtitle">Unified Senior Secondary &amp; Competitive Academic Architecture</p>
            </div>
          </div>
        ...
        <div class="academy-modal-body">
          <p class="academy-intro-note">
            Seamlessly transition between Chemistry, Physics, and Mathematics study engines. All platforms are strictly NCERT pure-line compliant with verified CBSE PYQ vaults and competitive modules.
          </p>
  ...
  function bindTriggers() {
    const triggers = document.querySelectorAll('.academy-modal-trigger, #academyModalToggle, .btn-cyber-academy');
